...
;; running total to zero is a winner.
;; However, it is normal to play a "doubles out" system,
;; which means that the player must land a double
;; (including the double bulls-eye at the centre of the board)
;; on their final dart to win;
;; any other dart that would reduce their running total to one or lower means the score
